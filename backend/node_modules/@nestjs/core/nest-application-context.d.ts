import { INestApplicationContext, ConsoleLogger, LoggerService, LogLevel, ShutdownSignal } from '@nestjs/common';
...
export declare class NestApplicationContext<TOptions extends NestApplicationContextOptions = NestApplicationContextOptions> extends AbstractInstanceResolver implements INestApplicationContext {
    ...
    constructor(container: NestContainer, appOptions?: TOptions, contextModule?: Module, scope?: Type<any>[]) {
        super();
        this.logger = new ConsoleLogger();  // Initialize with ConsoleLogger
    }
     ...
     * @returns {void}
     */
    useLogger(logger: LoggerService | LogLevel[] | ConsoleLogger | false): void {
        this.logger = logger as ConsoleLogger;
        this.flushLogsOnOverride();
      }
    /**
